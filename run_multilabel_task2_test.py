...
from data_test import make_data, create_task2_multi, make_dataframe_task2, TASK2_LABELS
...
def main():
    ...
    if model_args.do_predict:
        ...
        dev_folder = path_folder + '/data/{}/test-articles-subtask-2/'.format(data_args.pred_lang)
        ...
        output_pred_file = 'testpred/{}/testpred_task2_{}_{}.csv'.format(data_args.pred_lang,data_args.pred_lang,model_args.model_name_or_path.partition('/')[2])
